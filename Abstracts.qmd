...
## Simplify RAG using Oracle Autonomous Database Select AI

**Date & Time:** November 13 at 2:05 PM, Eastern

### Abstract

Retrieval augmented generation (RAG) combines vector search with generative AI – enabling more relevant and up-to-date responses from your large language model (LLM). In this session, we highlight using R to invoke Oracle Autonomous Database Select AI for accessing AI models (LLMs and transformers) and automating vector index creation and the RAG pipeline. Our scenario leverages R Consortium blog content to ask natural language questions and show specific text chunk content supporting RAG-enhanced responses. We'll demonstrate the definition and use of R functions that leverage Select AI database functions and procedures.
